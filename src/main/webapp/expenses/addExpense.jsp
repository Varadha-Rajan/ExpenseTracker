...
<head>
  ...
  <style>
    /* Add Expense Page Enhanced Glassmorphism CSS */
body {
...
.auth-input:focus {
    ...
    box-shadow: 
        ...
        0 5px 20px rgba(108, 99, 255, 0.15);
...
<body>
  ...
  <div class="auth-container">
    ...
    <form method="post" action="${pageContext.request.contextPath}/addExpense">
      <div class="form-row">
        <div class="form-group">
          <label> Date</label>
          <input type="date" name="date" class="auth-input" required>
        </div>
        <div class="form-group">
          <label> Category</label>
          <input type="text" name="category" class="auth-input" placeholder="e.g., Food, Transport, Entertainment" required>
        ...
        <div class="form-group">
          <label> Amount</label>
          <input type="number" step="0.01" name="amount" class="auth-input" placeholder="0.00" required>
        </div>
      </div>

      <div class="form-group">
        <label>📝 Notes (Optional)</label>
        <textarea name="notes" rows="3" class="auth-input" placeholder="Add any additional details about this expense..."></textarea>
      </div>
